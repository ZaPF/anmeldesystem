...
#       ('zeitmaschine', 'Zeitmaschine'),
    ...
    parktickets = SelectField('Ich hätte gerne Parktickets für die Nussallee(1,2€ pro Tag):', choices=[
        ('0','keins'),
        ('1','1'),
        ('2','2'),
        ('3','3'),
...
#   roemer = BooleanField('Ich möchte gerne einen Weinrömer bestellen')
    ...
    zaepfchen = SelectField('komsmt du zum ersten mal zu einer ZaPF?', choices=[
        ('ja','Ja'),
    ...
    halle = BooleanField('Ich habe die Hallenordnung (siehe Website) gelesen und verstanden und werde mich daran halten.', [validators.InputRequired()])
