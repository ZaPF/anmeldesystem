...
class RegistrationForm(FlaskForm):
    ...
    alternativprogramm = BooleanField(
        "Ich habe Interesse an einem Alternativprogramm zur Kneipentour"
    )
    ...
    anreisejahr = IntegerField(
        "Anreise aus dem Jahr:", [validators.optional()], widget=NumberInput()
    )
    abreise = SelectField(
